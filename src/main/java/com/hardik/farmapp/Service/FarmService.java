    ...
    public class FarmService {
        ...
        public Page<FarmAnalysis> getHistory(Authentication authentication, int pageNumber, int pageSize) {
            ...
            return farmAnalysisRepository.findByUserOrderByIdDesc(  user, pageable);
        }
